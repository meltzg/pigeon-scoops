    ...
    (t/are [to-type recipe-ingredient expected]
      (= (rm/change-unit-type to-type
                              ...
                              {::gs/unit-mass        2.0
                               ::gs/unit-mass-type   ::mass/kg
                               ::gs/unit-volume      3.0
                               ::gs/unit-volume-type ::vol/ml})
         expected)
      (namespace ::mass/g) {::rs/type        ::gs/milk
                            ::rs/amount      3
                            ::rs/amount-unit ::vol/ml} {::rs/type        ::gs/milk
                                                        ::rs/amount      2.0
                                                        ::rs/amount-unit ::mass/kg}
      (namespace ::vol/ml) {::rs/type        ::gs/milk
                            ::rs/amount      2
                            ::rs/amount-unit ::mass/kg} {::rs/type        ::gs/milk
                                                         ::rs/amount      3.0
                                                         ::rs/amount-unit ::vol/ml}
      (namespace ::vol/ml) {::rs/type        ::gs/milk
                            ::rs/amount      2
